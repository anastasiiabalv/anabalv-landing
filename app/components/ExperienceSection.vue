  ...
  <section id="experience">
    ...
    <div class="grid">
      <div class="flexcol">
        ...
        <div class="flex gap-10">
          <div class="infobox">
            <p class="text-3xl text-milk!">400+</p>
            <p class="">video edits</p>
          </div>
          <div class="infobox">
            <p class="text-3xl text-milk!">6 years</p>
...
.infobox {
  @apply bg-brownblock min-w-35 h-25 flexbox p-3 rounded-none;
